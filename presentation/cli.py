...
def main() -> None:
    ...
    parser.add_argument("--strategy", type=str, default="none",
                        choices=["none", "percent", "bulk", "composite", "minimum"],
                        help="Strategy kind")
    ...
    parser.add_argument("--min-amount", type=float, default=0.0, dest="min_amount",
                        help="Minimum order amount for minimum order discount")
    parser.add_argument("--discount-percent", type=float, default=0.0, dest="discount_percent",
                        help="Discount percentage for minimum order discount")
    ...
    strat = choose_strategy(args.strategy, percent=args.percent, sku=args.sku,
                            ...
                            min_amount=args.min_amount, discount_percent=args.discount_percent)
